...
const jp: LocaleType = {
  ...
  Error: {
    Unauthorized:
      "認証されていない状態です。ページを更新するか、再度ログインしてください。問題が解決されない場合は、ブラウザキャッシュをクリアしてみてください。",
    NoFee:
      "残りの無料会話回数が不十分です。**チャージ**してから再度お試しください。\nヘルプが必要な場合は、WeChatを使用して以下のQRコードをスキャンしてください：\n![gzh](/gzh.png)",
  },
  ChatItem: {
    ChatItemCount: (count: number) => `${count} 通のチャット`,
  },
  Chat: {
    SubTitle: (model, count) => `${model} との ${count} 通のチャット`,
    Actions: {
